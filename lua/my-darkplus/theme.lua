...
theme.set_highlights = function()
  ...
  hl(0, "EndOfBuffer", { fg = c.gray, bg = 'NONE' })
  ...
  hl(0, "LspReferenceRead", { fg = 'NONE', underline = true })
  hl(0, "LspReferenceText", { fg = 'NONE', underline = true })
  hl(0, "LspReferenceWrite", { fg = 'NONE', underline = true })
